...
export const metadata = {
  ...
  description: "Flow India Projects delivers comprehensive MEP, HVAC, electrical, plumbing, and fire protection engineering solutions across commercial, industrial, and government sectors in India.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Delivering precision-engineered HVAC, electrical, plumbing, and fire protection solutions across commercial, industrial, and government sectors in India.",
  ...
  twitter: {
    ...
    description: "Precision engineering for HVAC, electrical, plumbing, and fire protection systems across India.",
